...
const assetsURL = function(dep) {
  return "/stormbpmn_new_doc/pr-41/" + dep;
};
const seen = {};
...
var withBase = (url) => {
  if (isLinkHttp(url))
    return url;
  return `${"/stormbpmn_new_doc/pr-41/"}${removeLeadingSlash(url)}`;
};
...
const l$1 = define_SEARCH_PRO_OPTIONS_default, h = define_SEARCH_PRO_CUSTOM_FIELDS_default, p = l$1.hotKeys, P$1 = define_SEARCH_PRO_LOCALES_default, i = "Canceled because of new search request.", w = () => {
  const r2 = new Worker(`${"/stormbpmn_new_doc/pr-41/"}${l$1.worker}`, {}), s2 = { suggest: null, search: null, all: null };
...
const he$2 = /* @__PURE__ */ defineAsyncComponent({ loader: () => __vitePreload(() => import("./SearchResult-BbXcZoDF.js"), true ? [] : void 0), loadingComponent: () => {
...
const siteData$1 = JSON.parse('{"base":"/stormbpmn_new_doc/pr-41/","lang":"ru-RU","title":"Stormbpmn Docs","description":"Документация Stormbpmn","head":[["link",{"rel":"icon","href":"/stormbpmn_new_doc/pr-41/favicon.svg","type":"image/svg+xml"}],["link",{"rel":"stylesheet","href":"/stormbpmn_new_doc/pr-41/stylesheets/bpmn-embedded.css"}],["link",{"rel":"stylesheet","href":"/stormbpmn_new_doc/pr-41/stylesheets/bpmn-codes.css"}],["link",{"rel":"stylesheet","href":"/stormbpmn_new_doc/pr-41/stylesheets/extra.css"}],["link",{"rel":"stylesheet","href":"https://unpkg.com/primeicons/primeicons.css"}]],"locales":{}}');
var siteData = /* @__PURE__ */ shallowRef(siteData$1);
var historyCreator = createWebHistory;
var createVueRouter = () => {
  const router = createRouter({
    // it might be an issue of vue-router that have to remove the ending slash
    history: historyCreator(removeEndingSlash("/stormbpmn_new_doc/pr-41/")),
    routes: [
      {
        name: "vuepress-route",
        path: "/:catchAll(.*)",
...
var createVueApp = async () => {
  ...
  {
    const { setupDevtools } = await __vitePreload(() => import("./setupDevtools-X4YFRK4B-Bsknr52N.js"), true ? [] : void 0);
