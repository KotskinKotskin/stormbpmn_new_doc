...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[44] || (_cache[44] = createBaseVNode(
      ...
      [
        createBaseVNode("img", {
          src: "https://kotskinkotskin.github.io/stormbpmn_new_doc/pr-43/media/screenshots/app/access-group/access_groups_managment/groups.webp",
          alt: "groups"
        })
      ],
      -1
    ...
    _cache[46] || (_cache[46] = createStaticVNode('<h2 id="изменение-привилегии-групп" tabindex="-1"><a class="header-anchor" href="#изменение-привилегии-групп"><span>Изменение привилегий групп</span></a></h2><p>Администратор команды может включать или выключать любую привилегию в любой группе, включая группу <strong>Администраторы</strong>. Для изменения привилегии достаточно просто кликнуть по нужной привилегии и её статус изменится на противоположный:</p><p><img src="https://kotskinkotskin.github.io/stormbpmn_new_doc/pr-43/media/screenshots/app/access-group/access_groups_managment/toggle_permission.webp" alt=""></p><h2 id="гранулирование-прав-участников" tabindex="-1"><a class="header-anchor" href="#гранулирование-прав-участников"><span>Гранулирование прав участников</span></a></h2><p>Иногда может потребоваться более тонкое управление правами пользователей. Например, когда нужно запретить части пользователей работать с папками, но при этом оставить права на всё остальное. В таком случае можно создать отдельную группу, настроить набор прав и добавить пользователей в эту группу.</p><p>Такой процесс может выглядеть так:</p>', 6)),
    createBaseVNode("ol", null, [
      createBaseVNode("li", null, [
        ...
        _cache[32] || (_cache[32] = createBaseVNode(
          ...
          [
            createBaseVNode("img", {
              src: "https://kotskinkotskin.github.io/stormbpmn_new_doc/pr-43/media/screenshots/app/access-group/access_groups_managment/create_new_group.webp",
      ...
      _cache[38] || (_cache[38] = createBaseVNode(
        ...
        [
          ...
          createBaseVNode("p", null, [
            createBaseVNode("img", {
              src: "https://kotskinkotskin.github.io/stormbpmn_new_doc/pr-43/media/screenshots/app/access-group/access_groups_managment/setup_group_permissions.webp",
      ...
      createBaseVNode("li", null, [
        ...
        _cache[37] || (_cache[37] = createBaseVNode(
          ...
          [
            createBaseVNode("img", {
              src: "https://kotskinkotskin.github.io/stormbpmn_new_doc/pr-43/media/screenshots/app/access-group/access_groups_managment/add_user_to_new_groupp.webp",
