...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("ol", null, [
      ...
      createBaseVNode("li", null, [
        ...
        _cache[6] || (_cache[6] = createBaseVNode(
          ...
          [
            createBaseVNode("img", {
              src: "https://storage.yandexcloud.net/stormbpmn-img-prod/media/screenshots/app/diagram/create_arc_el/create_element_from_process_editor.webp",
      ...
      createBaseVNode("li", null, [
        ...
        _cache[11] || (_cache[11] = createBaseVNode(
          ...
          [
            createBaseVNode("img", {
              src: "https://storage.yandexcloud.net/stormbpmn-img-prod/media/screenshots/app/diagram/create_arc_el/create_element_from_process_editor_button_plus.webp",
    ...
    _cache[38] || (_cache[38] = createStaticVNode('<p><img src="https://storage.yandexcloud.net/stormbpmn-img-prod/media/screenshots/app/assets/work_with_arc_elements/arcitechture_element_table_list.webp" alt="arcitechture_element_table_list"></p><p>Каждый ЭА имеет свой ID, название, тип и набор действий, которые можно совершить над ним, к их числу отноятся:</p><ul><li><i class="pi pi-eye"></i> Просмотр списка диаграмм, где используется ЭА.</li><li><i class="pi pi-pen-to-square"></i> Редактирование свойств ЭА.</li><li><i class="pi pi-trash"></i> Удаление ЭА.</li></ul><p><img src="https://storage.yandexcloud.net/stormbpmn-img-prod/media/screenshots/app/assets/work_with_arc_elements/arc_elemets_actions.webp" alt="arc_elemets_actions"></p><h2 id="передача-диаграмм-с-эа-в-другую-команду" tabindex="-1"><a class="header-anchor" href="#передача-диаграмм-с-эа-в-другую-команду"><span>Передача диаграмм с ЭА в другую команду</span></a></h2><p>Если нужно передать диаграмму с элементами архитектуры в другую команду, создайте ее дубликат в другом аккаунте.</p><p>Для этого:</p><ol><li><p>Перейдите в редактор диаграмм.</p></li><li><p>На верхней панели кликнете по кнопке <i class="pi pi-share-alt"></i> <strong>Поделиться</strong>.</p></li><li><p>В открывшемся модальном окне <strong>Поделиться моделью</strong> укажите e-mail аккаунта получателя или включите <strong>Доступ по ссылке</strong> и скопируйте ссылку:</p><p><img src="https://storage.yandexcloud.net/stormbpmn-img-prod/media/screenshots/app/diagram/share_proc/share_process.webp" alt="share_process"></p></li><li><p>В аккаунте-получателе откройте переданную диаграмму по полученной ссылке.</p></li><li><p>Создайте копию диаграммы одним из способов:</p></li></ol>', 8)),
