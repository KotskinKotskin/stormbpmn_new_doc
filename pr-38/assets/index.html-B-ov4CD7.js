...
const data = JSON.parse('{"path":"/main/faq/status/","title":"","lang":"ru-RU","frontmatter":{"bp_reg":{"status":"<i class=\\"pi pi-sitemap\\"></i> **Статусы**"},"bp_tree":{"edit":"<i class=\\"pi pi-pencil\\"></i> **Редактировать**","tree":"<i class=\\"pi pi-sitemap\\"></i> **Дерево**"},"universal":{"delete":"<i class=\\"pi pi-trash\\"></i>","plus":"<i class=\\"pi pi-plus\\"></i>"}},"headers":[],"git":{"createdTime":null,"updatedTime":null,"contributors":[]},"readingTime":{"minutes":0.98,"words":294},"filePathRelative":"main/faq/status/index.md","excerpt":"<h4>Статусы бизнес-процессов</h4>\\n<details class=\\"hint-container details\\"><summary>Что такое </summary>\\n</details>\\n<details class=\\"hint-container details\\"><summary>Создание статуса бизнес-процесса</summary>\\n<p>Статусы бизнес-процессов создаются в разделе </p>\\n<p><img src=\\"https://storage.yandexcloud.net/stormbpmn-img-prod/media/screenshots/app/status/status_create/status_create.webp\\" alt=\\"status_create\\"></p>\\n</details>"}');
export {
  index_html as comp,
  data
};
//# sourceMappingURL=index.html-B-ov4CD7.js.map
