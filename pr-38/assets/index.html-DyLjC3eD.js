...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    _cache[31] || (_cache[31] = createBaseVNode(
      ...
      [
        createBaseVNode("img", {
          src: "https://storage.yandexcloud.net/stormbpmn-img-prod/main/quick_start/img/main_window.webp",
          alt: "main_window"
        })
      ],
      -1
    ...
    _cache[32] || (_cache[32] = createBaseVNode(
      ...
      [
        createBaseVNode("img", {
          src: "https://storage.yandexcloud.net/stormbpmn-img-prod/main/quick_start/img/main_window_create_new_model.webp",
    ...
    _cache[35] || (_cache[35] = createBaseVNode(
      ...
      [
        createBaseVNode("img", {
          src: "https://storage.yandexcloud.net/stormbpmn-img-prod/main/quick_start/img/simple_model.webp",
          alt: "simple_model"
        })
      ],
      -1
    ...
    _cache[36] || (_cache[36] = createBaseVNode(
      ...
      [
        createBaseVNode("img", {
          src: "https://storage.yandexcloud.net/stormbpmn-img-prod/main/quick_start/img/simple_model_check_mistakes_sum.webp",
    ...
    _cache[37] || (_cache[37] = createBaseVNode(
      ...
      [
        createBaseVNode("img", {
          src: "https://storage.yandexcloud.net/stormbpmn-img-prod/main/quick_start/img/simple_process_final.webp",
    ...
    _cache[38] || (_cache[38] = createBaseVNode(
      ...
      [
        createBaseVNode("img", {
          src: "https://storage.yandexcloud.net/stormbpmn-img-prod/main/quick_start/img/save_model.webp",
          alt: "save_model"
        })
      ],
      -1
