...
ℹ️🔽 "Что такое {{ bp_reg.custom_fields }}?"

    {{ bp_reg.custom_fields }} — это перечень всех возможных атрибутов и параметров процесса, которые позволяют настроить реестр процессов в соответствии со спецификой отрасли или компании.
...
ℹ️🔽 "Создание пользовательских полей"
    ...
    ![]({{ media.screenshots.custom_fields }}/{{ media.actions.cf_create }}/cf_create.png)
