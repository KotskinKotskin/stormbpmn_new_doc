...
ℹ️🔽 "Автонумерация элементов диаграммы"
    ...
    По умолчанию автонумерация выключена, чтобы её включить кликните по {{ process_editor.right_toolbar.buttons.extra }} и из выпадащего списка выбирите нужный вам вариант нумерации:
    ...
    - {{ process_editor.upper_toolbar.extra.num_all }} — нумеровать все элементы диаграммы, вкдючая пулы. Этот вариант нумерации обычно используют для работы с регламентами.
