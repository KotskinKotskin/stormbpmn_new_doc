...
ℹ️🔽 "Назначить нескольким задачам одновременно одну роль и/или элемент архитектуры"
    ...
    1. В редакторе диаграмм кликните по {{ process_editor.right_toolbar.buttons.archetecture }} правого тулбара — откроется меню добавления ролей и элементов архитектуры к «активным» элементам диаграммы:
