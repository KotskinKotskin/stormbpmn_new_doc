...
ℹ️🔽 "Автонумерация элементов диаграммы"
    ...
    По умолчанию автонумерация выключена, чтобы её включить кликните по {{ process_editor.right_toolbar.extra }} и из выпадащего списка выбирите нужный вам вариант нумерации:
