...
ℹ️🔽 "Что такое {{ bp_reg.status }}?"
    ...
    ![status_example]({{ media.screenshots.diagram }}/{{ status_example }}/status_example.png)
...
ℹ️🔽 "Создание статуса бизнес-процесса"
    ...
    ![status_create]({{ media.screenshots.status }}/{{ status_create }}/status_create.png)
...
ℹ️🔽 "Редактирование и удаление статуса бизнес-процесса"
    ...
    ![status_edit_del]({{ media.screenshots.status }}/{{ status_edit }}/status_edit_del.png)
...
ℹ️🔽 "Использование статуса бизнес-процесса"
    ...
    1. Выберите нужный вам бизнес-процесс и нажмите кнопку {{ bp_tree.edit }}:
        ...
        ![status_edit_step-01]({{ media.screenshots.status }}/{{ status_edit }}/status_edit_step-01.png)
    ...
    1. В открывшемся модальном окне **Редактирование бизнес-процесса** кликните по выпадающему списку **Статус** и выберите нужный вам статус бизнес-процесса:
        ...
        ![status_edit_step-02]({{ media.screenshots.status }}/{{ status_edit }}/status_edit_step-02.png)
