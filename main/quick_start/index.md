...
- {{ create_model.copy }} — создайте копию существующей модели для модификации.
...
Теперь можно сказать — быстрый старт в {{ product_name }} завершён. Мы создали базовую, простую и рабочую модель. Далее модель можно усложнять, добавляя другие логические элементы процесса.