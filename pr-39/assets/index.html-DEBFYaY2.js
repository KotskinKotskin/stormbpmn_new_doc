...
const data = JSON.parse('{"path":"/main/faq/custom-fields/","title":"","lang":"ru-RU","frontmatter":{"bp_reg":{"custom_fields":"<i class=\\"pi pi-sliders-h\\"></i> **Пользовательские поля**"},"bp_tree":{"metrics":"<i class=\\"pi pi-chart-line\\"></i> **Показатели**","options":"<i class=\\"pi pi-hashtag\\"></i> **Параметры**"},"universal":{"plus":"<i class=\\"pi pi-plus\\"></i>"}},"headers":[],"git":{"createdTime":null,"updatedTime":null,"contributors":[]},"readingTime":{"minutes":1.53,"words":459},"filePathRelative":"main/faq/custom-fields/index.md","excerpt":"<h4>Пользовательские поля</h4>\\n<details class=\\"hint-container details\\"><summary>Что такое </summary>\\n</details>\\n<details class=\\"hint-container details\\"><summary>Создание пользовательских полей</summary>\\n<p>Все пользовательские поля, кроме <strong>Метрика</strong>, отражаются во вкладке </p>\\n<p><img src=\\"https://kotskinkotskin.github.io/stormbpmn_new_doc/pr-39/media/screenshots/app/custom_fields/create/cf_create.webp\\" alt=\\"\\"></p>\\n</details>"}');
export {
  index_html as comp,
  data
};
