...
Автосохранённые диаграммы по умолчанию не отображаются в истории версионирования процесса. Чтобы увидеть автосохранённые версии процесса нужно установить чекбокс {{ process_versions.checkboxs.show_autosave }}:
