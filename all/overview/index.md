...
![edit_process_overview_mistakes]({{ media.screenshots.diagram }}/{{ media.actions.edit_process_overview }}/edit_process_overview_mistakes.png)
...
![edit_process_overview_graph]({{ media.screenshots.diagram }}/{{ media.actions.edit_process_overview }}/edit_process_overview_graph.png)
...
![edit_process_overview_mistakes_tabs]({{ media.screenshots.diagram }}/{{ media.actions.edit_process_overview }}/edit_process_overview_mistakes_tabs.png)
...
![edit_process_overview_mistakes_marker]({{ media.screenshots.diagram }}/{{ media.actions.edit_process_overview }}/edit_process_overview_mistakes_marker.png)
...
- **Небольшое замечание** — не критичное уведомление, которое мало влияет на общую оценку качества процесса. Обозначается знаком {{ team.team_settings.small_mistake }}. Например, {{ team.team_settings.small_mistake }} **Нет имени** или {{ team.team_settings.small_mistake }} **Задачи без маркеров**:
    ...
    ![overview_small_mistake]({{ media.screenshots.diagram }}/{{ media.actions.edit_process_overview }}/overview_small_mistake.png)
...
- **Обратить внимание** — важное уведомление, которое средне влияет на общую оценку качества процесса. Обозначается знаком {{ team.team_settings.attention }}. Например, {{ team.team_settings.attention }} **Много выходящих потоков**:
    ...
    ![overview_attention]({{ media.screenshots.diagram }}/{{ media.actions.edit_process_overview }}/overview_attention.png)
...
- **Ошибка** — критически важное уведомление, которое сильно влияет на общую оценку качества процесса. Обозначается также знаком {{ team.team_settings.attention }}. Например, {{ team.team_settings.attention }} **Нет завершающего события**:
    ...
    ![overview_error]({{ media.screenshots.diagram }}/{{ media.actions.edit_process_overview }}/overview_error.png)
